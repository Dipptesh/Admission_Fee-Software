<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ManageData.aspx.vb" Inherits="WebApplication1.ManageData" %>
...
<head runat="server">
  ...
  <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
    ...
    <style>
        ...
        table tr:not(:first-child):hover{background-color:#808080;}
    </style>
</head>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <form runat="server" id="Form2">
             <asp:TextBox ID="search" runat="server" placeholder="Search Students/ Departments/ Course.." OnDataBinding="searchbtn_Click" Width="75%"></asp:TextBox>
             <asp:Button ID="searchbtn" runat="server" Text="Search" />&nbsp<asp:Button ID="refresh" runat="server" Text="Refresh" /><br /><br />
              <div>
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="stud_no" ShowFooter="True" AllowPaging="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                      <Columns>
